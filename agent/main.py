...
about_me = [
    ...
    {
        "input": "I currently take medication for blood pressure and cholesterol management.",
        "output": "Got it!",
    },
]
...
def fallback_response(user_input, generated_response):
    if is_sensitive_query(user_input):
        return (
            "I'm sorry you're experiencing these feelings. It sounds like you could use professional help. "
